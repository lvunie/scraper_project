...
//////////////////////////////////////////////////////////////////////////////////
		...
		.scrape(function($) {
			return $(".left-tabs a").map(function() {
				...
				error_index2++;
				console.log('write: '+error_index2+ '  ' + address );
...
error_index_overview++;
//console.log('1.overview: ' + error_index_overview);	
...
// write to process.md
error_index_process++;
//console.log('2.process: ' + error_index_process);
...
function scrape4(address){
	...
	scraperjs.StaticScraper.create(address)
		...
		.scrape(function($) {
				...
				html = S(html).collapseWhitespace().s;
				html = toMarkdown(html);
// write to intelligence.md	
error_index_intellenge++;
//console.log('3.intelligence: ' + error_index_intellenge);
				make_tab_folder(json.filename, option, html);

	})
}

function scrape5(address){
...
// write to impact.md
error_index_impact++;
//console.log('4.impact: ' + error_index_impact);
...
function make_tab_folder(address, option , text ){
	...
	var md_result = writeToMarkdown(option_markdown, text);
...
//console.log('start writing..... ' + option_markdown);
	...
	var point1 = fs.writeFile(option_markdown, text, function(err){
       		//console.log('write done: ' + option_markdown);
