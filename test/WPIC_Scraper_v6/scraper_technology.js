...
function createFolder(){
	...
	var pathName = '/home/lvunie/work/scraper_project/WPIC_Scraper_v5/technology_output'; 
...
rd.on('line', function(line) {
	...
	var pageTwo = S(line).indexOf('category/technology');
...
///////////////////////////////////////////////////////////////////////////////////////////////////////	
				...
				items[14].cate_heading = S(string).trim().s;
...
function writeToJson(address,json){
	...
	var pathName = '/home/lvunie/work/scraper_project/WPIC_Scraper_v5/technology_output/' + fileIndex; 
