...
function scrape(address){
	...
	scraperjs.StaticScraper.create(address)
				...
				json[indexOfURL].filename = address.slice(index+1); 
...
////////////////////////////////Process content//////////////////////////////////
		...
		.scrape(function($) {
			...
			option = 'Process';
			process_path = make_tab_folder(json[indexOfURL].filename, option, html_png );
...
////////////////////////////// content ////////////////////////////////
		.scrape(function($) {
				...
				option = 'Overview';
				overview_path = make_tab_folder(json[indexOfURL].filename, option, text );
		...
		.scrape(function($) {
				...
				option = 'Impact';
				impact_path = make_tab_folder(json[indexOfURL].filename, option, text );
